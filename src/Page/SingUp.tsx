    ...
    return(
        <div>
             <div>
                  ...
                  <h1 className="text-3xl font-bold text-center font-serif text-black mb-2 pt-6">Create Account   </h1>
                  ...
                  <button className="bg-white p-3 rounded-full shadow-md">
                    ...
                    Already have an account ? {" "}
                      <Link to="/signin" className="text-[#1D3557] font-semibold hover:underline font-serif">
                      Log in 
                      </Link>
                    </p>
